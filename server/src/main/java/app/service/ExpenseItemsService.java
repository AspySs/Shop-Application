...
public class ExpenseItemsService {
    ...
    @Autowired
    public ExpenseItemsService(ExpenseItemRepository repository, ChargeRepository chargeRepository){this.repository = repository; this.chargeRepository = chargeRepository;}
